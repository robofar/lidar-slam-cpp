...
class Dataset {
  public:
    ...
    Eigen::Matrix3Xd cur_point_cloud;
    Eigen::VectorXd cur_reflectance;
    ...
    Eigen::Matrix3Xd cur_source_points;
    Eigen::VectorXd cur_source_reflectance;
    Eigen::Matrix3Xd cur_source_colors;
    Eigen::Matrix3Xd cur_source_normals;
